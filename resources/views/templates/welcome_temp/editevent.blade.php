            ...
            <div class="container">
                <div class="row">
                            ...
                            <form method="get" class="custom-form contact-form" role="form">
                                <div class="row" style="padding-top: 20px">
                                    <div class="col-lg-12 col-12">
                                        <input class="form-control" id="name" name="name" placeholder="Event Name"  value="{{$data['name']}}"></input>

                                        <input class="form-control" id="location" name="location" placeholder="Event Location" value="{{$data['location']}}"></input>
                                        
                                        <div class="form-floating">
                                            <textarea class="form-control" id="description" name="message" placeholder="ddffrfe">{{$data['description']}}</textarea>
                            ...
                            <div class="profile-body">
                                ...
                                <p style="display:flex">
                                    ...
                                    <span style="width:100%" class="c-vert">
                                        <input id="date" type="text" value="{{$data['date']}}"/>
                                    </span>                                    
                                </p>
                                ...
                                <p style="display:flex">
                                    ...
                                    <span style="width:100%" class="c-vert">
                                        <input id="time" type="text" value="{{$data['time']}}"/>
                                    </span>                                    
                                </p>
                                ...
                                <p style="display:flex">
                                    ...
                                    <span style="width:100%" class="c-vert">
                                        <input id="duration" type="text" value="{{$data['duration']}}"/>
                                    </span>                                    
                                </p>
                                ...
                                <p style="display:flex">
                                    ...
                                    <span style="width:100%" class="c-vert">
                                        <input id="anchor" type="text" value="{{$data['anchor']}}"/>
                                    </span>                                    
                                </p>
                    ...
                    <div style="margin-left:0px" class="custom-form contact-form">
                        <div style="text-align:center" id="queue" type="update" class="form-control">Update</div>
                    </div>
